...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Hub.Platforms.Android.MessageService, Hub", MessageService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MessageService.class) {
			mono.android.TypeManager.Activate ("Hub.Platforms.Android.MessageService, Hub", "", this, new java.lang.Object[] {  });
		}
	}
